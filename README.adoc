...
It targets RabbitMQ 4.0+ and requires at least Java 17 (Java 21 or more is recommended).
...
This library requires at least Java 17 (Java 21+ is recommended) and RabbitMQ 4.0 or more.
...
(c) 2024-2026 Broadcom. All Rights Reserved.
