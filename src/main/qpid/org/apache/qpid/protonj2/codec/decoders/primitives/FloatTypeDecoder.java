...
public final class FloatTypeDecoder extends AbstractPrimitiveTypeDecoder<Float> {
    ...
    public static final FloatTypeDecoder INSTANCE = new FloatTypeDecoder();
    ...
    @Override
    public float[] readPrimitiveArray(ProtonBuffer buffer, DecoderState state, int count) {
    ...
    @Override
    public float[] readPrimitiveArray(InputStream stream, StreamDecoderState state, int count) {
