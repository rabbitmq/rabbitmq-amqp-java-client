...
public final class ShortTypeDecoder extends AbstractPrimitiveTypeDecoder<Short> {
    ...
    public static final ShortTypeDecoder INSTANCE = new ShortTypeDecoder();
    ...
    @Override
    public short[] readPrimitiveArray(ProtonBuffer buffer, DecoderState state, int count) {
    ...
    @Override
    public short[] readPrimitiveArray(InputStream stream, StreamDecoderState state, int count) {
