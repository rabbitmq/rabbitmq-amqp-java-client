...
public final class CoordinatorTypeDecoder extends AbstractDescribedListTypeDecoder<Coordinator> {
    ...
    public static final CoordinatorTypeDecoder INSTANCE = new CoordinatorTypeDecoder();
    ...
    protected int getMinListElements() {
        return MIN_COORDINATOR_LIST_ENTRIES;
    }

    @Override
    protected int getMaxListElements() {
        return MAX_COORDINATOR_LIST_ENTRIES;
    }

    @Override
    protected Coordinator readType(int count, ProtonBuffer buffer, Decoder decoder, DecoderState state) throws DecodeException {
    ...
    @Override
    protected Coordinator readType(int count, InputStream stream, StreamDecoder decoder, StreamDecoderState state) throws DecodeException {
        final Coordinator coordinator = new Coordinator();
