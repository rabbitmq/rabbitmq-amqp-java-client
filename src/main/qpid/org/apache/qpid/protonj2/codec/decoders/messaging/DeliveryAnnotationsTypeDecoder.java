 ...
 */
public final class DeliveryAnnotationsTypeDecoder extends AbstractDescribedMapTypeDecoder<DeliveryAnnotations, Symbol> {

    public static final DeliveryAnnotationsTypeDecoder INSTANCE = new DeliveryAnnotationsTypeDecoder();
    ...
    @Override
    protected DeliveryAnnotations createDescribed(Map<Symbol, Object> map) {
