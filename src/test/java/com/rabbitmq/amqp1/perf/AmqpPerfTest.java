...
// info@rabbitmq.com.
package com.rabbitmq.amqp1.perf;
...
import com.rabbitmq.amqp1.impl.TestUtils;
import com.rabbitmq.amqp1.metrics.MetricsCollector;
import com.rabbitmq.amqp1.metrics.MicrometerMetricsCollector;
...
public class AmqpPerfTest {
  ...
  ./mvnw -q clean test-compile exec:java \
    -Dexec.mainClass=com.rabbitmq.amqp1.perf.AmqpPerfTest \
