...
import static com.rabbitmq.amqp1.Management.ExchangeType.DIRECT;
import static com.rabbitmq.amqp1.Management.ExchangeType.FANOUT;
import static com.rabbitmq.amqp1.Management.QueueType.QUORUM;
import static com.rabbitmq.amqp1.impl.TestUtils.CountDownLatchConditions.completed;
import static com.rabbitmq.amqp1.impl.TestUtils.assertThat;
import static com.rabbitmq.amqp1.impl.TestUtils.environmentBuilder;
import static com.rabbitmq.amqp1.impl.TestUtils.waitAtMost;
...
public class AmqpTest {
  ...
  void queueDeclareDeletePublishConsume(TestInfo info) {
    ...
    try {
      ...
      com.rabbitmq.amqp1.Consumer consumer =
          connection
              .consumerBuilder()
              .queue(q)
              .messageHandler(
  ...
  void pauseShouldStopMessageArrivalUnpauseShouldResumeIt() throws Exception {
    ...
    Set<com.rabbitmq.amqp1.Consumer.Context> messageContexts = ConcurrentHashMap.newKeySet();
    com.rabbitmq.amqp1.Consumer consumer =
        connection
            .consumerBuilder()
            .queue(q)
    ...
    new ArrayList<>(messageContexts).forEach(com.rabbitmq.amqp1.Consumer.Context::accept);
