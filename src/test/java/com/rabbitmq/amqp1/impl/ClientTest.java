...
import com.rabbitmq.amqp1.Management;
...
public class ClientTest {
  ...
  static com.rabbitmq.amqp1.Connection connection;
  String q;
  ...
  void queueDeletionImpactOnReceiver(TestInfo info) throws Exception {
    ...
    try (Environment env = new AmqpEnvironmentBuilder().build();
         com.rabbitmq.amqp1.Connection connection = env.connectionBuilder().build();
