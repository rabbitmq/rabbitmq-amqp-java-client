...
.Explicit exchange-to-queue binding
[source,java,indent=0]
--------
include::{test-examples}/Api.java[tag=queue-binding]
--------
<1> The destination is a queue (the default)
...
--------
<1> The destination is an exchange
